...
from gag_v2.utils import deserialize_translated_fields
#from gag_v2.codegen import CoreNetwork

@click.command("fetch_api")
@with_appcontext
def fetch_api():
    import requests
    from gag_v2.config import API_BASE_URL
...
@with_appcontext
def test():
    import gag_v2.models as models
    # from gag_v2.models import CoreTopology, TrekkingPoi, TrekkingPoitype, AuthentStructure, TrekkingTrek, TrekkingDifficultylevel, TrekkingRoute, TrekkingPractice, CommonReservationsystem
    from gag_v2.env import fk_not_integrated, specific, source_cat_to_gag_cat, core_topology, common, list_label_field
    from gag_v2.config import API_BASE_URL, AUTHENT_STRUCTURE
    from gag_v2.utils import geom4326_to_wkt, camel_case, get_fk_row, create_topology, get_api_field
...
@with_appcontext
def populate_db():
    from gag_v2.models import TrekkingPoi, TrekkingPoitype
    from gag_v2.env import fk_not_integrated, source_cat_to_gag_cat
    from sqlalchemy import inspect
