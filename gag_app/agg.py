...
from gag_app.classes import ParserImportAPIv2ContentTypeModel
...
with transaction.atomic():
    ...
    for model_to_import_name, model_to_import_properties in model_to_import.items():
        main_parser = ParserImportAPIv2ContentTypeModel(
        ...
        # app_name = ContentType.objects.get(model=model_to_import_name.lower()).app_label
        # print('app_name: ', app_name)
        # current_model = apps.get_model(app_name, model_to_import_name)
        # print('current_model: ', current_model)

        # api_model = model_to_import_name.lower()  # ex: Trek => trek
        ...
        #     fk_not_integrated = {}
        #     for fk_model_name, api_fk_route in model_to_import_properties["fk_not_integrated"].items():
        #         url = api_base_url + api_fk_route
        ...
        #                 print(model_to_import_name, ': topology exists')
        ...
        #                 if f_name in model_to_import_properties["db_column_api_field"]:
        #                     dict_to_insert = get_api_field(api_data, index, f_name, model_to_import_properties["db_column_api_field"], dict_to_insert)
        ...
        #                 else:
        #                     new_value = source_cat_to_gag_cat[AUTHENT_STRUCTURE][model_to_import_name][f_related_model][old_value[0]]
        ...
        #             elif fk_field in model_to_import[model_to_import_name]["db_column_api_field"]:
        #                 api_field = model_to_import[model_to_import_name]["db_column_api_field"][fk_field]
        ...
        #                 new_value = source_cat_to_gag_cat[AUTHENT_STRUCTURE][model_to_import_name][f_related_model][old_value]
